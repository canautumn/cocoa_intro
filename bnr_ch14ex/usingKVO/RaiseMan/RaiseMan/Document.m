...
static void *DefaultsKVOContext;
...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleDefaultsChange:) name:NSUserDefaultsDidChangeNotification object:nil];
        [[NSUserDefaults standardUserDefaults] addObserver:self forKeyPath:TableBgColorKey options:NSKeyValueObservingOptionNew context:&DefaultsKVOContext];
    }
    return self;
}
...
//    [[NSNotificationCenter defaultCenter] removeObserver:self];
    [[NSUserDefaults standardUserDefaults] removeObserver:self forKeyPath:TableBgColorKey];
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    if (context == &DefaultsKVOContext) {
        [_tableView setBackgroundColor:[NSKeyedUnarchiver unarchiveObjectWithData:[change valueForKey:NSKeyValueChangeNewKey]]];
        return;
    }

...
- (IBAction)removeEmployee:(id)sender {
    ...
    NSAlert *alert = [NSAlert alertWithMessageText:@"Do you really want to remove these people?" defaultButton:@"Remove" alternateButton:@"Cancel" otherButton:@"Keep, but no raise" informativeTextWithFormat:@"%lu people will be removed.", [selectedPeople count]];
    NSLog(@"Starting alert sheet");
    [alert beginSheetModalForWindow:[_tableView window] modalDelegate:self didEndSelector:@selector(alertEnded:code:context:) contextInfo:NULL];
}
